...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center text-white">Ventas</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item text-white"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item text-white active">Ventas</li>
    </ol>
            ...
            <table id="datatablesSimple" class="table table-striped acrilico text-white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="fw-semibold mb-1 text-white">{{ ucfirst($item->cliente->persona->tipo_persona) }}</p>
                            <p class=" mb-0 text-white">{{$item->cliente->persona->razon_social}}</p>
                        </td>
                        <td>
