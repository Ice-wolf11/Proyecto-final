...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center text-white">Realizar Venta</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{ route('ventas.index')}}">Ventas</a></li>
        <li class="breadcrumb-item active text-white">Realizar Venta</li>
    </ol>
</div>
...
<form action="{{ route('ventas.store') }}" method="post">
    ...
    <div class="container-lg mt-4">
        <div class="row gy-4">
            ...
            <!------venta producto---->
            <div class="col-xl-8">
                <div class="text-white acrilico p-1 text-center">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="col-12 col-sm-6">
                                <div class="row">
                                    <label for="stock" class="col-form-label col-4 text-white">Stock:</label>
                                    <div class="col-8">
                        ...
                        <div class="col-12 text-end">
                            <button id="btn_agregar" class="btn btn-primary text-white" type="button">Agregar</button>
                        </div>
