...
<div class="container-fluid ">
    <h1 class="mt-4 text-center text-white">Ver Venta</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item text-white"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item text-white"><a href="{{ route('ventas.index')}}">Ventas</a></li>
        <li class="breadcrumb-item text-white active">Ver Venta</li>
    </ol>
</div>
