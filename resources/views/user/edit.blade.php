...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center text-white">Editar Usuario</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item text-white"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item text-white"><a href="{{ route('users.index')}}">Usuarios</a></li>
        <li class="breadcrumb-item text-white active">Editar Usuario</li>
    </ol>
