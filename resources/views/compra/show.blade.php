...
<div class="container-fluid">
    <h1 class="mt-4 text-center text-white">Ver Compra</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item text-white"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item text-white"><a href="{{ route('compras.index')}}">Compras</a></li>
        <li class="breadcrumb-item text-white active">Ver Compra</li>
    </ol>
</div>

<div class="container-fluid">

    <div class="caja mb-4 acrilico">
    ...
    <!---Tabla--->
    <div class="acrilico caja mb-2">
        <div class="card-header  text-white">
            <i class="fas fa-table me-1 text-white "></i>
            Tabla de detalle de la compra
        </div>
        <div class="card-body table-responsive">
            <table class="table table-striped acrilico">
                <thead class="acrilico">
                    <tr class="align-top">
                ...
                <tbody class="acrilico">
                    ...
                    <tr>
                        ...
                        <td class="td-subtotal text-white">
                            {{($item->pivot->cantidad) * ($item->pivot->precio_compra)}}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot class="acrilico">
                    <tr>
                        <th colspan="5" class="text-white"></th>
                    </tr>
                    <tr>
                        <th colspan="4" class="text-white">Sumas:</th>
                        <th id="th-suma" class="text-white"></th>
                    </tr>
                    <tr>
                        <th colspan="4" class="text-white">IGV:</th>
                        <th id="th-igv" class="text-white"></th>
                    </tr>
                    <tr>
                        <th colspan="4" class="text-white">Total:</th>
                        <th id="th-total" class="text-white"></th>
                    </tr>
                </tfoot>
            </table>
        </div>
