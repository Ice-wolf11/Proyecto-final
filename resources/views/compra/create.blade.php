...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center text-white">Crear Compra</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{ route('compras.index')}}">Compras</a></li>
        <li class="breadcrumb-item active text-white">Crear Compra</li>
    </ol>
</div>
...
<form action="{{ route('compras.store') }}" method="post">
    ...
    <div class="container-lg mt-4">
        <div class="row gy-4">
            <!------Compra producto---->
            <div class="col-xl-8 ">
                <div class="text-white  p-1 text-center acrilico">
                    Detalles de la compra
                </div>
                <div class="p-3 acrilico ">
                    <div class="row">
                        <!-----Producto---->
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="tabla_detalle" class="table table-hover o">
                                    <thead class="">
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-white"><span id="sumas">0</span></th>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            <th colspan="4" class="text-white">IGV %</th>
                                            <th colspan="2" class="text-white"><span id="igv">0</span></th>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            <th colspan="4" class="text-white">Total</th>
                                            <th colspan="2" class="text-white"> <input type="hidden" name="total" value="0" id="inputTotal"> <span id="total">0</span></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                ...
                <div class="p-3 acrilico">
                    <div class="row ">
                        ...
                        <div class="col-12 mb-2">
                            <label for="proveedore_id" class="form-label text-white">Proveedor:</label>
                        ...
                        <!--Tipo de comprobante-->
                        <div class="col-12 mb-2">
                            <label for="comprobante_id" class="form-label text-white">Comprobante:</label>
                        ...
                        <div class="col-12 mb-2">
                            <label for="numero_comprobante" class="form-label text-white">Numero de comprobante:</label>
                        ...
                        <div class="col-sm-6 mb-2">
                            <label for="impuesto" class="form-label text-white">Impuesto(IGV):</label>
                        ...
                        <div class="col-12 mt-4 text-center">
                            <button type="submit" class="btn btn-success text-white" id="guardar">Realizar compra</button>
                        </div>
