...
<head>
    ...
    <meta name="author" content="Andrew-Yubert-Samuel" />
...
<body class=" fondo ">
    <div id="layoutAuthentication" class="caja">
        <div id="layoutAuthentication_content" >
            <main>
                <div class="container ">
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="caja acrilico">
                                <div class="card-header">
                                    <h3 class="text-center text-white font-weight-light my-4">Acceso al sistema</h3>
                                </div>
                                <div class="card-body">
                                    @if ($errors->any())
